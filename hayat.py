...
│ \033[93m╭──────────────────────────────────────────────────────────╮ \033[1;32m│
│ \033[93m│\033[1;32m  █████████████████████████████ \x1b[1;96mGithub  \x1b[1;97
		self.id = []
		self.ok = []
		self.cp = []
		self.loop = 0
		...
		print("│ \033[32m╭──────────────────────────────────────────────────────────╮ \33[m│")
		print("│ \033[32m│                     ███████████████                     │ \33[m│")
		print("│ \033[32m│                     ██ 𝗙 𝗧 __ 𝗛 𝗔 𝗬 𝗔 𝗧         │ \33[m│")
		print("│ \033[32m│                     ███████████████                     │\33[m │")
		print("│ \033[32m│   ─━㋱Status : FT HAYAT   WhatsApp : 03118484294㋱━─   │ \33[m│")
		print("│ \033[32m╰──────────────────────────────────────────────────────────╯ \33[m│")
		print("╰──────────────────────────────────────────────────────────────╯\33[m")
		print("╔══════════════════════════════════════════════════════════════╗")
		...
		if TUTUL in ["5", "05"]:
			self.old2()
	def old(self):
		x = 1WITH PASSWORD -> [\033[0;91m%s\033[0;93m]"%(G,listpass))
				os.system("clear")
				print(logo)
				print("\n%s \x1b[1;97m[H] FAISAL OK ID SAVED : OK.txt"%(Y))1; SAMSUNG SM-G920P Build/LMY47X) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.2 Chrome/38.0.2125.102 Mobile Safari/537.36",
  ...
  "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.6; rv:10.0) Gecko/20100101 Firefox/
